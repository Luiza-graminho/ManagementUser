...
public PerfilService(AppDbContext context, ILogger<PerfilService>
logger)
{
_context = context;
_logger = logger;
...
public async Task<PerfilDto.PerfilResponse> UpdatePerfil(int id,
...
Nome = perfil.Nome,
Descricao = perfil.Descricao,
Usuarios = perfil.Usuarios.Select(u => new
PerfilDto.UserShortResponse
{
